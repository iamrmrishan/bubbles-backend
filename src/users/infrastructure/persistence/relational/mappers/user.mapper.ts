...
export class UserMapper {
  static toDomain(raw: UserEntity): User {
    ...
    } else if (raw.coverPhoto === null) {
      domainEntity.coverPhoto = null;
    }

    domainEntity.bio = raw.bio;

    domainEntity.isCreator = raw.isCreator;
  ...
  static toPersistence(domainEntity: User): UserEntity {
    ...
    if (domainEntity.coverPhoto) {
      persistenceEntity.coverPhoto = FileMapper.toPersistence(
        domainEntity.coverPhoto,
      );
    } else if (domainEntity.coverPhoto === null) {
      persistenceEntity.coverPhoto = null;
    }

    persistenceEntity.bio = domainEntity.bio;

    persistenceEntity.isCreator = domainEntity.isCreator;
